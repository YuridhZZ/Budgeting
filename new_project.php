	...
	<div class="card card-outline card-primary">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label for="" class="control-label">Part/Field/Unit</label>
					<input type="text" class="form-control form-control-sm" name="unit" required value="<?php echo isset($unit) ? $unit : '' ?>">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label for="" class="control-label">Activity</label>
					<input type="text" class="form-control form-control-sm" name="activity"  required value="<?php echo isset($activity) ? $activity : '' ?>">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label for="" class="control-label">Activity Goal</label>
					<input type="text" class="form-control form-control-sm" name="activity_goal" required value="<?php echo isset($activity_goal) ? $activity_goal : '' ?>">
				</div>
			</div>
          	<div class="col-md-6">
				<div class="form-group">
      ...
      <?php endif; ?>
		...
		<div class="row">
			<div class="col-md-10">
				<div class="form-group">
					<label for="" class="control-label">Activity Description</label>
