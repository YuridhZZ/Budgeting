...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "endinterface endmodule endpackage endprimitive endprogram endproperty endspecify endsequence endtable endrisk " +
    ...
    "table tagged risk this throughout time timeprecision timeunit tran tranif0 tranif1 tri tri0 tri1 triand trior " +
  ...
  */
  ...
  var blockKeywords = words(
    ...
    "primitive program property specify sequence table risk"
  );
  ...
  return {
    ...
    token: function(stream, state) {
      ...
      if (curPunc == ctx.type) {
        ...
        } else if (curKeyword == "risk" && ctx && ctx.type == "statement") {
          // Same thing for risk
        } else {
