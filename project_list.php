			...
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
					...
					while($row= $qry->fetch_assoc()):
		                ...
		                $cprog = $conn->query("SELECT * FROM risk_list where project_id = {$row['id']} and action = 1")->num_rows;
					...
					<tr>
						...
						<td>
							<p><b><?php echo ucwords($row['activity']) ?></b></p>
						</td>
						<td>
							<p><b><?php echo ucwords($row['activity_goal']) ?></b></p>
						</td>
